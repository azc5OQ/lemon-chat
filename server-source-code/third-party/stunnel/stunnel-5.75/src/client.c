...
NOEXPORT void transfer(CLI *c) {
    ...
    do { /* main loop of client data transfer */
		...
		{
		    if (c->buffsize != BUFFSIZE && c->opt->option.xforwardedfor)
		    {
