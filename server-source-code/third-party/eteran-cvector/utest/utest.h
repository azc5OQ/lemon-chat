...
#define utest_type_printer(val)                                                                                                                                                                                                                                                                                                             \
    UTEST_PRINTF(_Generic((val), signed char: "%d", unsigned char: "%u", short: "%d", unsigned short: "%u", int: "%d", long: "%ld", long long: "%lld", unsigned: "%u", unsigned long: "%lu", unsigned long long: "%llu", float: "%f", double: "%f", long double: "%Lf", default: _Generic((val - val), ptrdiff_t: "%p", default: "undef")), \
                 (val))
#else
/*
