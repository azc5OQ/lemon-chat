...
/* some handy macros */
#define mp_init(a)                   ltc_mp_init(a)
#define mp_init_multi                ltc_init_multi
#define mp_clear(a)                  ltc_mp_deinit(a)
#define mp_clear_multi               ltc_deinit_multi
#define mp_cleanup_multi             ltc_cleanup_multi
#define mp_init_copy(a, b)           ltc_mp_init_copy(a, b)

#define mp_neg(a, b)                 ltc_mp_neg(a, b)
#define mp_copy(a, b)                ltc_mp_copy(a, b)

#define mp_set(a, b)                 ltc_mp_set_int(a, b)
#define mp_set_int(a, b)             ltc_mp_set_int(a, b)
#define mp_get_int(a)                ltc_mp_get_int(a)
#define mp_get_digit(a, n)           ltc_mp_get_digit(a, n)
#define mp_get_digit_count(a)        ltc_mp_get_digit_count(a)
#define mp_cmp(a, b)                 ltc_mp_compare(a, b)
#define mp_cmp_d(a, b)               ltc_mp_compare_d(a, b)
#define mp_count_bits(a)             ltc_mp_count_bits(a)
#define mp_cnt_lsb(a)                ltc_mp_count_lsb_bits(a)
#define mp_2expt(a, b)               ltc_mp_twoexpt(a, b)

#define mp_read_radix(a, b, c)       ltc_mp_read_radix(a, b, c)
#define mp_toradix(a, b, c)          ltc_mp_write_radix(a, b, c)
#define mp_unsigned_bin_size(a)      ltc_mp_unsigned_size(a)
#define mp_to_unsigned_bin(a, b)     ltc_mp_unsigned_write(a, b)
#define mp_read_unsigned_bin(a, b, c) ltc_mp_unsigned_read(a, b, c)

#define mp_add(a, b, c)              ltc_mp_add(a, b, c)
#define mp_add_d(a, b, c)            ltc_mp_addi(a, b, c)
#define mp_sub(a, b, c)              ltc_mp_sub(a, b, c)
#define mp_sub_d(a, b, c)            ltc_mp_subi(a, b, c)
#define mp_mul(a, b, c)              ltc_mp_mul(a, b, c)
#define mp_mul_d(a, b, c)            ltc_mp_muli(a, b, c)
#define mp_sqr(a, b)                 ltc_mp_sqr(a, b)
#define mp_div(a, b, c, d)           ltc_mp_divide(a, b, c, d)
#define mp_div_2(a, b)               ltc_mp_div_2(a, b)
#define mp_mod(a, b, c)              ltc_mp_divide(a, b, NULL, c)
#define mp_mod_d(a, b, c)            ltc_mp_modi(a, b, c)
#define mp_gcd(a, b, c)              ltc_mp_gcd(a, b, c)
#define mp_lcm(a, b, c)              ltc_mp_lcm(a, b, c)

#define mp_addmod(a, b, c, d)        ltc_mp_addmod(a, b, c, d)
#define mp_submod(a, b, c, d)        ltc_mp_submod(a, b, c, d)
#define mp_mulmod(a, b, c, d)        ltc_mp_mulmod(a, b, c, d)
#define mp_sqrmod(a, b, c)           ltc_mp_sqrmod(a, b, c)
#define mp_invmod(a, b, c)           ltc_mp_invmod(a, b, c)

#define mp_montgomery_setup(a, b)    ltc_mp_montgomery_setup(a, b)
#define mp_montgomery_normalization(a, b) ltc_mp_montgomery_normalization(a, b)
#define mp_montgomery_reduce(a, b, c)   ltc_mp_montgomery_reduce(a, b, c)
#define mp_montgomery_free(a)        ltc_mp_montgomery_deinit(a)

#define mp_exptmod(a,b,c,d)          ltc_mp_exptmod(a,b,c,d)
#define mp_prime_is_prime(a, b, c)   ltc_mp_isprime(a, b, c)
...
#define mp_rand(a, b)                ltc_mp_set_rand(a, b)
