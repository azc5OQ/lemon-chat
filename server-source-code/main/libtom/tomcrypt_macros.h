...
#define LOAD32L(x, y)                                                                                                                               \
	do                                                                                                                                          \
	{                                                                                                                                           \
		x = ((ulong32)((y)[3] & 255) << 24) | ((ulong32)((y)[2] & 255) << 16) | ((ulong32)((y)[1] & 255) << 8) | ((ulong32)((y)[0] & 255)); \
	} while (0)
...
#define LOAD64L(x, y)                                                                                                                                                                                                                                                                                       \
	do                                                                                                                                                                                                                                                                                                  \
	{                                                                                                                                                                                                                                                                                                   \
		x = (((ulong64)((y)[7] & 255)) << 56) | (((ulong64)((y)[6] & 255)) << 48) | (((ulong64)((y)[5] & 255)) << 40) | (((ulong64)((y)[4] & 255)) << 32) | (((ulong64)((y)[3] & 255)) << 24) | (((ulong64)((y)[2] & 255)) << 16) | (((ulong64)((y)[1] & 255)) << 8) | (((ulong64)((y)[0] & 255))); \
	} while (0)
...
#define LOAD32H(x, y)                                                                                                                               \
	do                                                                                                                                          \
	{                                                                                                                                           \
		x = ((ulong32)((y)[0] & 255) << 24) | ((ulong32)((y)[1] & 255) << 16) | ((ulong32)((y)[2] & 255) << 8) | ((ulong32)((y)[3] & 255)); \
	} while (0)
...
#define LOAD64H(x, y)                                                                                                                                                                                                                                                                                       \
	do                                                                                                                                                                                                                                                                                                  \
	{                                                                                                                                                                                                                                                                                                   \
		x = (((ulong64)((y)[0] & 255)) << 56) | (((ulong64)((y)[1] & 255)) << 48) | (((ulong64)((y)[2] & 255)) << 40) | (((ulong64)((y)[3] & 255)) << 32) | (((ulong64)((y)[4] & 255)) << 24) | (((ulong64)((y)[5] & 255)) << 16) | (((ulong64)((y)[6] & 255)) << 8) | (((ulong64)((y)[7] & 255))); \
	} while (0)
...
#define STORE32H(x, y)                                \
	do                                            \
	{                                             \
		ulong32 ttt = __builtin_bswap32((x)); \
		XMEMCPY((y), &ttt, 4);                \
	} while (0)
...
#define STORE64H(x, y)                                \
	do                                            \
	{                                             \
		ulong64 ttt = __builtin_bswap64((x)); \
		XMEMCPY((y), &ttt, 8);                \
	} while (0)
...
#define ROLc(word, i)                                                                            \
	({                                                                                       \
		...
		__asm__("roll %2, %0" : "=r"(LTC_TMPVAR(ROLc)) : "0"(LTC_TMPVAR(ROLc)), "I"(i)); \
		LTC_TMPVAR(ROLc);                                                                \
	})
#define RORc(word, i)                                                                            \
	({                                                                                       \
		ulong32 LTC_TMPVAR(RORc) = (word);                                               \
		__asm__("rorl %2, %0" : "=r"(LTC_TMPVAR(RORc)) : "0"(LTC_TMPVAR(RORc)), "I"(i)); \
		LTC_TMPVAR(RORc);                                                                \
	})
...
#define ROL64c(word, i)                                                                              \
	({                                                                                           \
		...
		__asm__("rolq %2, %0" : "=r"(LTC_TMPVAR(ROL64c)) : "0"(LTC_TMPVAR(ROL64c)), "J"(i)); \
		LTC_TMPVAR(ROL64c);                                                                  \
	})
#define ROR64c(word, i)                                                                              \
	({                                                                                           \
		ulong64 LTC_TMPVAR(ROR64c) = word;                                                   \
		__asm__("rorq %2, %0" : "=r"(LTC_TMPVAR(ROR64c)) : "0"(LTC_TMPVAR(ROR64c)), "J"(i)); \
		LTC_TMPVAR(ROR64c);                                                                  \
	})
