...
The two webassemlies are minimp3 and libopus

Purpose of minimp3 WebAssembly
...
To remove minimp3 (which is likely unnecessary anyway):
...
The minimp3 WebAssembly file is much smaller, around 30 KB in client.html
