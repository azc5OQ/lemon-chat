...
|---|---|---|
| `assets/client.html` | `client-development/build.py` | `client-development/src/` (template.html, scripts/, styles/) |
| `assets/nodejs-project/` | `nodejs-client/build-node.py` | `nodejs-client/` + the same `src/scripts/` |
