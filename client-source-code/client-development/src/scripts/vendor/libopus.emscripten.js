            ...
            //this is .wasm (webassembly) file stored as base64 string, to avoid need of fetching it using http, it is embedded straight into html file
            //base64 string is later decoded into array of bytes. (312546 bytes total after decoding)
            //this exact base64 string can be reproduced by building separate project on my github, here https://github.com/azc5OQ/libopusjs
            ...
            if (ENVIRONMENT_IS_NODE)
            {
                ...
                if (ENVIRONMENT_IS_SHELL)
                {
                    ...
                    {
                        window.setTimeout(() => onload(readBinary(f)), 0);
                    };
            ...
            function create_opus_webassembly_instance()
            {
                // prepare imports
                var info = {
                    'env': wasmImports,
                ...
                console.log(THREAD_NAME + " instantiate_libopus_webassembly_from_base64(info, receiveInstantiationResult);");

                instantiate_libopus_webassembly_from_base64(info, receiveInstantiationResult);
            ...
            function instantiate_libopus_webassembly_from_base64(imports, callback)
            {
                var libopus_webassembly_base64 = '@@WASM:wasm/libopus.wasm@@';           
                let webassembly_bytes = decode(libopus_webassembly_base64);
                var result = WebAssembly.instantiate(webassembly_bytes, imports);
            ...
            /** @type {function(...*):?} */
            var _opus_decoder_ctl = Module["_opus_decoder_ctl"] = createExportWrapper("opus_decoder_ctl");
            /** @type {function(...*):?} */
            ...
            /** @type {function(...*):?} */
            var _speex_resampler_init = Module["_speex_resampler_init"] = createExportWrapper("speex_resampler_init");
            /** @type {function(...*):?} */
            var _speex_resampler_destroy = Module["_speex_resampler_destroy"] = createExportWrapper("speex_resampler_destroy");
            /** @type {function(...*):?} */
            var _speex_resampler_process_interleaved_float = Module["_speex_resampler_process_interleaved_float"] = createExportWrapper("speex_resampler_process_interleaved_float");
            /** @type {function(...*):?} */
