            // the audio engine, split out of main.js (same script element, same scope - the build
            // splices this file right before main.js, so everything here sees main.js variables).
