...
../browser/build.py, different include list.
...
Paths starting with `node/` resolve next to this script, everything else under ../browser/src.
"""
import base64
import os
import re
...
DEV = os.path.normpath(os.path.join(HERE, "..", "browser"))
