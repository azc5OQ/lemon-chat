...
Output: ../../client.html, i.e. client-source-code/client.html, the shipped client itself,
...
# The build output IS the shipped client: overwrite client-source-code/client.html, two levels up
# (this script lives in client-source-code/client-development/browser).
